...
using netcore_angular9_mariadb.Data;
using netcore_angular9_mariadb.Models;

namespace netcore_angular9_mariadb.Controllers
{
    ...
    public class BlogPostsController : ControllerBase
    {
        ...
        private readonly InterfaceDataRepository<BlogPost> _repo;

        public BlogPostsController(BlogPostsContext context, InterfaceDataRepository<BlogPost> repo)
        {
            _context = context;
            _repo = repo;
        }
